...
//		$nonce = rwmb_request()->filter_post( "nonce_{$this->id}", FILTER_SANITIZE_STRING );// deprecated in php 8.1
        $nonce = wp_strip_all_tags( rwmb_request()->filter_post( "nonce_{$this->id}" ) );
