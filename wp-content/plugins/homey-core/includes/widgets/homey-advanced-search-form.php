...
//        $hide_host_languages_section = $instance[ 'hide_host_languages_section' ];
        ...
        <div class="widget-body">
                <form class="clearfix"  action="<?php echo homey_get_search_result_page(); ?>" method="GET">
                    ...
                    <?php if(!$hide_size_section): ?>
                        ...
                        <h4 class="widget-filter-title"><?php echo esc_html__('Size', 'homey'); ?></h4>
                            <?php
                                $listing_min_num = get_option('listing_homey_bedrooms_min', 0);
                                $listing_max_num = get_option('listing_homey_bedrooms_max', 0);
                            ...
                            <select class="selectpicker" title=Bedrooms>
                                <?php $already_added = array(); for($listing_min_num; $listing_min_num <= $listing_max_num; $listing_min_num += $steps) {
                                    if(isset($already_added[$listing_min_num])) continue;
                                     ?>
                                    <option value="<?php echo $listing_min_num; ?>"><?php echo $listing_min_num; ?></option>
                               <?php $already_added[$listing_min_num] = $listing_min_num;
                                } ?>
                            </select>

                        <?php
                            $listing_min_num = get_option('listing_homey_baths_min', 0);
                            $listing_max_num = get_option('listing_homey_baths_max', 0);
                            $listing_max_num = $listing_max_num > 10 ? $listing_max_num : 10;
                        ...
                        <?php
                        $listing_min_num = get_option('listing_homey_guests_min', 0);
                        $listing_max_num = get_option('listing_homey_guests_max', 0);
                        $listing_max_num = $listing_max_num > 10 ? $listing_max_num : 10;
                    ...
                    <?php if(!$hide_price_section): ?>
                        ...
                        <?php
                        $listing_min_num_opt = get_option('listing_night_price_min', 0);
                        $listing_max_num_opt = get_option('listing_night_price_max', 0);

                        $listing_min_num = $listing_min_num_opt > 0 ? $listing_min_num_opt : 0;
                        $listing_max_num = $listing_max_num_opt > 0 ? $listing_max_num_opt : 0;
                        ...
                        <select class="selectpicker" title=Max.>
                            <?php $already_added = array(); for($listing_min_num; $listing_min_num <= $listing_max_num; $listing_min_num += $steps) {
                                ...
                                <option value="<?php echo $listing_min_num; ?>"><?php echo $listing_min_num; ?></option>
                            <?php
                                $already_added[$listing_min_num] = $listing_min_num; } ?>
                            <option value="<?php echo $listing_max_num_opt; ?>"><?php echo $listing_max_num_opt; ?></option>
                    ...
                    <?php if(!$hide_amenities_section): ?>
                        ...
                        <div class="filters">
                            ...
                            foreach ($terms as $term){
                                $alreadyAmenities[] = $term->term_id;
                                ?>
                                <label class="control control--checkbox">
                                    <input data-is-amen-list="1" <?php echo in_array($term->term_id, $amenities) ? 'checked' : ''; ?> id="host_amenities_<?php echo $term->term_id; ?>" name="amenities[]" type="checkbox" value="<?php echo $term->term_id; ?>">
                        ...
                        <div class="collapse" id="collapseAmenities-mobile">
                            <div class="filters">
                                <?php foreach ($terms as $term){
                                    if(!in_array($term->term_id, $alreadyAmenities)){
                                    ?>
                                    <label class="control control--checkbox">
                                        <input <?php echo in_array($term->term_id, $amenities) ? 'checked' : ''; ?> data-is-amen-list-mob="1" id="host_amenities_<?php echo $term->term_id; ?>" name="amenities[]" type="checkbox" value="<?php echo $term->term_id; ?>">
                                        <span class="control-text"><?php echo esc_html__($term->name, 'homey'); ?></span>
                                        <span class="control__indicator"></span>
                                    </label>
                                <?php }
                    ...
                    <?php if(!$hide_facilities_section): ?>
                        ...
                        <div class="filters">
                            ...
                            foreach ($terms as $term){
                                $alreadyFacilities[] = $term->term_id;
                                ?>
                                <label class="control control--checkbox">
                                    <input <?php echo in_array($term->term_id, $facilities) ? 'checked' : ''; ?> id="host_facilities_<?php echo $term->term_id; ?>" name="facilities[]" type="checkbox" value="<?php echo $term->term_id; ?>">
                                    <span class="control-text"><?php echo esc_html__($term->name, 'homey'); ?></span>
                                    <span class="control__indicator"></span>
                                </label>
                            <?php } ?>
                        ...
                        <div class="collapse" id="collapseFacilities-mobile">
                            <div class="filters">
                                <?php foreach ($terms as $term){
                if(!in_array($term->term_id, $alreadyFacilities)){
                ...
                ?>
                    ...
                    <?php if(1==2 && !$hide_neighborhoods_section): ?>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        /* Stripe tags to remove HTML. For text inputs and textarea. */
