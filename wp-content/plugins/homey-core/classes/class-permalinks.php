...
class Homey_Permalinks {
    ...
    public static function homey_register_settings() {
        ...
        //add_settings_field( 'experience_what_give_item_type_rewrite_base',   esc_html__( 'Experiences What Bring Item',   'homey-core' ), array( __CLASS__, 'experience_what_give_item_type_callback'   ), 'homey_permalinks', 'permalinks' );
