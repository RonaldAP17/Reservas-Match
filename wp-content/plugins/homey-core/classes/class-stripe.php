...
class Homey_Stripe
{
     ...
     */
    function homey_stripe_form($amount, $metadata, $description, $is_experience = 0)
    {
        ...
        if (isset($metadata['payment_type']) && $metadata['payment_type'] == 'featured_fee') {
            if ($is_experience > 0) {
                $redirect_type = "back_to_experience_with_featured";
            } else {
        ...
        <div id="stripe_main_wrap" style="display: none;">
                ...
                <fieldset>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="stripe_cardholder_name" type="text"
                                   placeholder="<?php esc_html_e('Your Name', 'homey-core'); ?>" required
                                   value="<?php echo esc_attr($this->display_name); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="stripe_cardholder_email" type="text"
                                   placeholder="<?php esc_html_e('Your Email', 'homey-core'); ?>" required
                                   value="<?php echo esc_attr($this->user_email); ?>">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                    <button type="submit" id="homey_stripe_submit_btn" class="btn btn-success btn-full-width"
                            data-secret="<?php echo $this->payment_intent_secret; ?> "><?php echo esc_html__('Process Payment', 'homey'); ?></button>
                </div>
